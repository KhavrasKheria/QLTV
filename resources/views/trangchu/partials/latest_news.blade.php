				...
				<div class="row">
					...
					<div id="tg-postslider" class="tg-postslider tg-blogpost owl-carousel">
						<article class="item tg-post">
							<figure><a href="javascript:void(0);"><img src="book_library/images/blog/img-01.jpg" alt="image description"></a></figure>
						...
						<article class="item tg-post">
							<figure><a href="javascript:void(0);"><img src="book_library/images/blog/img-02.jpg" alt="image description"></a></figure>
							<div class="tg-postcontent">
								<ul class="tg-bookscategories">
									<li><a href="javascript:void(0);">Adventure</a></li>
									<li><a href="javascript:void(0);">Fun</a></li>
						...
						<article class="item tg-post">
							<figure><a href="javascript:void(0);"><img src="book_library/images/blog/img-03.jpg" alt="image description"></a></figure>
							<div class="tg-postcontent">
								<ul class="tg-bookscategories">
									<li><a href="javascript:void(0);">Adventure</a></li>
									<li><a href="javascript:void(0);">Fun</a></li>
						...
						<article class="item tg-post">
							<figure><a href="javascript:void(0);"><img src="book_library/images/blog/img-04.jpg" alt="image description"></a></figure>
							<div class="tg-postcontent">
								<ul class="tg-bookscategories">
									<li><a href="javascript:void(0);">Adventure</a></li>
									<li><a href="javascript:void(0);">Fun</a></li>
